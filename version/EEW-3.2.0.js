...
const Plugin = {
    ...
    "author": ["whes1015"],
    "link": "https://github.com/ExpTechTW/MPR-EEW",
    "resources": ["AGPL-3.0"],
    "description": "地震速報",
    "DHL": false
}
...
async function connect() {
    ...
    ws.onmessage = async function (e) {
        ...
        if (Data.Function == "earthquake") {
            ...
            await Client.channels.cache.get(await DB.read(Plugin, "channel")).send(`http://150.117.110.118/earthquake/${Data.Time}.jpg`)
